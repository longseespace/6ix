...
class UserModule extends CWebModule
{
	...
	static private $_userByEmail=array();
	...
	public static function getUserByEmail($email) {
		if (!isset(self::$_userByEmail[$email])) {
          self::$_userByEmail[$email] = User::model()->findByAttributes(array('email'=>$email));
		}
		return self::$_userByEmail[$email];
	}
